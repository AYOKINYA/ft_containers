...
namespace ft
{
	...
	class AVLtreeRIterator
	{
		...
		public:
				...
				AVLtreeRIterator(const AVLtreeRIterator<Key, T, k_cmp> & copy)
				 : tree_root_(copy.tree_root_), node_(copy.node_) {};

				~AVLtreeRIterator() {};
				AVLtreeRIterator<Key, T, k_cmp>& operator=(const AVLtreeRIterator<Key, T, k_cmp> & rhs)
				{
					if (this == &rhs)
						return (*this);
					this->node_ = rhs.node_;
				...
				AVLtreeRIterator<Key, T, k_cmp>& operator--()
				{
					if (!node_)
						return (*this);
					if (node_->right)
				...
				AVLtreeRIterator<Key, T, k_cmp> operator--(int)
				{
					AVLtreeRIterator<Key, T, k_cmp> tmp(*this);
					operator--();
					return (tmp);
				}
				...
				bool	operator==(const AVLtreeRIterator<Key, T, k_cmp> &rhs) const
				{
					return (this->node_ == rhs.node_);
				}
	...
	template <typename Key, typename T, typename k_cmp>
 	bool operator== (const AVLtreeRIterator<Key, T, k_cmp>& lhs, const AVLtreeRIterator<Key, T, k_cmp>& rhs)
	{
	...
	template <typename Key, typename T, typename k_cmp>
	AVLtreeRIterator<Key, T, k_cmp> operator+(typename AVLtreeRIterator<Key, T, k_cmp>::difference_type n,
											const AVLtreeRIterator<Key, T, k_cmp>& rev_it)
	{
		AVLtreeRIterator<Key, T, k_cmp> res(rev_it.getPtr() - n);
		return (res);
	}
	...
	class AVLtree
	{
		public:
				...
				typedef AVLtreeRIterator<Key, T, k_cmp>				reverse_iterator;
				typedef AVLtreeRIterator<Key, T, k_cmp>				const_reverse_iterator;
